...
Body: JSON payload with arbitrary data fields; `latitude`/`longitude` zijn gestript en gebruikt om locatie bij te werken als aanwezig
...
- Many UI endpoints zijn form-based; prefer the JSON `/api/...` endpoints for Postman testing.
